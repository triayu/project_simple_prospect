...
import 'package:simple_prospect/app/modules/home/contact/contact_view.dart';
...
class HomeView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    List<Widget?> homes = [DashBoardView(), EventView(), ContactView(), TaskView(), ProfileView()];
    List<IconData?> icon = [
      Ti.home,
      Ti.calendar,
      null,
                            ...
                            : Column(
                                children: [
                                  Icon(
                                    icon[i],
                                    size: 25,
                                    color: state.activeIndex == i ? Colors.black : Colors.black45,
                                  ),
                                  title[i] != null
                                      ? Text(
                                          title[i]!,
